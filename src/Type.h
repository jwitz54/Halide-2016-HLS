...
template<> struct halide_c_type_to_name<test_int> { static const bool known_type = true; static halide_cplusplus_type_name name() { return { halide_cplusplus_type_name::Simple,  "test_int"}; } };
template<> struct halide_c_type_to_name<test_int_t<int64_t>> { static const bool known_type = true; static halide_cplusplus_type_name name() { return { halide_cplusplus_type_name::Simple,  "test_int"}; } };
